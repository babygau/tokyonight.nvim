...
function M.setup(config)
  ...
  theme.base = {
    ...
    LineNr = { bg = util.lighten(c.bg, 0.99), fg = c.fg_gutter }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
  ...
  theme.plugins = {
    ...
    -- Telescope
    TelescopeBorder = { fg = c.teal },
    TelescopeSelection = { fg = c.fg, bg = c.none },
    TelescopeMultiSelection = { fg = c.fg, bg = c.none },
    ...
    RedrawDebugNormal = { fg = c.error },
    RedrawDebugClear = { fg = c.error },
    RedrawDebugComposed = { fg = c.error },
    RedrawDebugRecompose = { fg = c.error },
